...
> **Decidido: la app NO descarga idiomas por su cuenta.** Se importan desde un
> archivo. Así la promesa de «sin servidores» se mantiene intacta.
...
2. **Retrotraducción asistida** *(pendiente)*. La propuesta se traduce de vuelta
   al español con IA para poder revisar el **contenido**, no solo la forma. Sin
   esto, aprobar un idioma que no se lee sería firmar en blanco.
3. **Revisión humana obligatoria** de Jordi Beold.
...
| Retrotraducción asistida | **Pendiente** |
| Descarga automática desde la web | **Descartado a propósito** |

## 15. Pendientes conocidos

- **Retrotraducción asistida** para poder revisar traducciones en idiomas que no
  se leen. Es lo único que falta del circuito de aportaciones.
